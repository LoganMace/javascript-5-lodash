...
// Bonus Points
const totalByMonth = _.reduce(purchasesByMonth.price, function(total, curr){return total + curr}); // Use the grouped purchasesByMonth and reduce to create a totalByMonth object.
